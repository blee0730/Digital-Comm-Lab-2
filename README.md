...
The WBFM block is the frequency demodulator that converts the complex FM signal into a float with a quadrature rate of 400kHz which is the sampling frequency of the demodulator. This makes it so the complex frequency signal can be read by the computer.
### Resampler
